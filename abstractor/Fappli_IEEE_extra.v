...
Local Arguments B754_zero {_ _} _.
Local Arguments B754_infinity {_ _} _.
Local Arguments B754_nan {_ _} _ _.
Local Arguments B754_finite {_ _} _ _ _ _.
...
Definition Bconv (conv_nan: bool -> nan_pl prec1 -> bool * nan_pl prec2) (md: mode) (f: binary_float1) : binary_float2 :=
  match f with
    | B754_nan s pl => let '(s, pl) := conv_nan s pl in B754_nan s pl
...
Definition b32_exact_inverse : binary32 -> option binary32 := Bexact_inverse 24 128 prec32 eq_refl.
...
Definition b64_exact_inverse : binary64 -> option binary64 := Bexact_inverse 53 1024 prec64 eq_refl.
