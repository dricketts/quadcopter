...
Definition neg: float32 -> float32 := b32_opp. (**r opposite (change sign) *)
Definition abs: float32 -> float32 := b32_abs abs_pl. (**r absolute value (set sign to [+]) *)
Definition add: float32 -> float32 -> float32 := b32_plus mode_NE. (**r addition *)
Definition sub: float32 -> float32 -> float32 := b32_minus mode_NE. (**r subtraction *)
Definition mul: float32 -> float32 -> float32 := b32_mult mode_NE. (**r multiplication *)
Definition div: float32 -> float32 -> float32 := b32_div mode_NE. (**r division *)
