...
% was P.v part of the memocode paper?
% perhaps move last sentence of paragraph 1 here
...
%For example, in reasoning about the height of the quadcopter over a time interval, we have to consider simultaneously the impulse delivered by its motors and the effect of environmental factors such as wind and gravity. That is, [INSERT MATH].



\section {Experiences}          % Should this be folded into the narrative about
                                % the two stability proofs?


% Coq as a reasoning aid
In attempting to extend the proof of Lyapunov stability for exponential stability, we discovered that


% Real arithmetic, powers and floating point
